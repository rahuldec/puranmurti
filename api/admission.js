...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const url = `${ERP_BASE}/getAdmissionDashboard/dashboard?entity=${encodeURIComponent(entity)}&session=${encodeURIComponent(erpSession)}&admissionSession=${encodeURIComponent(erpSession)}`;
